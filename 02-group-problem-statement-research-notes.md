...
| Rank  | Problem                                 | Vì sao chọn                                                                                                                                                                                                                                                                  | Điều chưa chắc                                                                                                                                                   |
| :---: | --------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1** | Khoảng cách giao tiếp giữa các team     | Xảy ra rất thường xuyên trong mọi buổi cross-team meeting (Tech, Business, Design). Gây mất thời gian trực tiếp trong quá trình ra quyết định vì phải liên tục giải thích lại cùng một thuật ngữ hoặc ý tưởng. Đây là “friction layer” rõ ràng trong workflow làm việc nhóm. | Khó đo chính xác mức độ “hiểu đúng” sau khi giải thích, và không có metric rõ ràng để biết khi nào communication đã thực sự được cải thiện.                      |
| **2** | Quá tải thông tin khi research          | Xuất hiện trong hầu hết workflow của knowledge workers. Mỗi lần cần hiểu một vấn đề đều phải đọc nhiều nguồn rời rạc, gây tốn thời gian và dễ mất insight quan trọng. Đây là bước tổng hợp có giá trị cao nhưng đang bị làm thủ công.                                        | Chất lượng “tổng hợp đúng và đủ” rất khó đánh giá, vì mỗi người có mức độ depth khác nhau khi research cùng một vấn đề.                                          |
| **3** | Brief không rõ dẫn đến làm sai sản phẩm | Là vấn đề phổ biến trong workflow sản phẩm, gây rework nhiều vòng giữa PM và team execution. Tác động trực tiếp đến tốc độ delivery và chi phí sửa lỗi. Đây là điểm gãy giữa “intent” và “implementation”.                                                                   | Phụ thuộc rất nhiều vào chất lượng input ban đầu từ stakeholder. Khó xác định AI có thể chuẩn hóa hoàn toàn requirement hay không nếu context ban đầu quá mơ hồ. |
